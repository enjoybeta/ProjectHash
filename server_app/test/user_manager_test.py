...
class WebManagerTest(unittest.TestCase):
    ...
    def test_upload_download(self):
        ...
        user_manager.sign_up(json.dumps({"username": "test1", "password": "t1", "email": "test1@t.com"}))
        user_manager.sign_up(json.dumps({"username": "test2", "password": "t2", "email": "test2@t.com"}))
        string1 = user_manager.upload(json.dumps({"username": "test1", "password": "t1", "favoriteStr": "favorite test", "ingredientStr": "ingreidents test"}))
        string2 = user_manager.upload(json.dumps({"username": "test1", "password": "t2", "favoriteStr": "favorite test", "ingredientStr": "ingreidents test"}))
        string3 = user_manager.upload(json.dumps({"username": "test2", "password": "t2", "favoriteStr": "favorite test2", "ingredientStr": "ingreidents test2"}))
        ...
        self.assertEqual(string4,json.dumps({"username": "test1", "favoriteStr": "favorite test", "ingredientStr": "ingreidents test"}))
        self.assertEqual(string5,json.dumps({"username": "test2", "favoriteStr": "favorite test2", "ingredientStr": "ingreidents test2"}))
